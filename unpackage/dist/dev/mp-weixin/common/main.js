...
_vue.default.use(_uviewUi.default);var vuexStore = __webpack_require__(/*! @/store/$u.mixin.js */ 46);_vue.default.mixin(vuexStore);var app = new _vue.default(_objectSpread({ store: _store.default }, _App.default)); // http拦截器，此为需要加入的内容，如果不是写在common目录，请自行修改引入路径
